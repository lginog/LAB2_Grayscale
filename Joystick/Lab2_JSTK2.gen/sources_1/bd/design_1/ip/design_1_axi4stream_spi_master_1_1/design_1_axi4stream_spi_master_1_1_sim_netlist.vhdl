...
-- Date        : Mon Apr 10 17:15:01 2023
-- Host        : WIN7390 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               c:/Users/posta/Src/LAB2_git/Joystick/Lab2_JSTK2.gen/sources_1/bd/design_1/ip/design_1_axi4stream_spi_master_1_1/design_1_axi4stream_spi_master_1_1_sim_netlist.vhdl
...
entity design_1_axi4stream_spi_master_1_1_lw_spi_master is
  port (
    cs_o : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME of design_1_axi4stream_spi_master_1_1_lw_spi_master : entity is "lw_spi_master";
end design_1_axi4stream_spi_master_1_1_lw_spi_master;

architecture STRUCTURE of design_1_axi4stream_spi_master_1_1_lw_spi_master is
  ...
  signal \edgecntr[9]_i_4_n_0\ : STD_LOGIC;
  signal edgecntr_reg : STD_LOGIC_VECTOR ( 9 downto 0 );
  ...
  attribute SOFT_HLUTNM of cs_o_i_2 : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of data_ready_reg_i_1 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \edgecntr[1]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \edgecntr[2]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \edgecntr[3]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \edgecntr[4]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \edgecntr[6]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \edgecntr[7]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \edgecntr[8]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \edgecntr[9]_i_2\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of mosi_o_i_3 : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of new_data_i_1 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of sclk_en_i_1 : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of \write_reg[7]_i_6\ : label is "soft_lutpair4";
begin
  sclk_o <= \^sclk_o\;
...
\edgecntr[6]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
        ...
        port map (
      I0 => \edgecntr[9]_i_4_n_0\,
      I1 => edgecntr_reg(6),
      O => \p_0_in__0\(6)
    );
\edgecntr[7]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"78"
    )
        port map (
      I0 => edgecntr_reg(6),
      I1 => \edgecntr[9]_i_4_n_0\,
      I2 => edgecntr_reg(7),
      O => \p_0_in__0\(7)
    );
...
\edgecntr[9]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\edgecntr[9]_i_4\: unisim.vcomponents.LUT6
    generic map(
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_axi4stream_spi_master_1_1_axis_lw_spi_master is
  port (
    m_axis_tdata : out STD_LOGIC_VECTOR ( 7 downto 0 );
    sclk_o : out STD_LOGIC;
    cs_o : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_axi4stream_spi_master_1_1_axis_lw_spi_master : entity is "axis_lw_spi_master";
end design_1_axi4stream_spi_master_1_1_axis_lw_spi_master;

architecture STRUCTURE of design_1_axi4stream_spi_master_1_1_axis_lw_spi_master is
...
inst_lw_spi_master: entity work.design_1_axi4stream_spi_master_1_1_lw_spi_master
     port map (
      aclk => aclk,
      aresetn => aresetn,
      cs_o => cs_o,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_axi4stream_spi_master_1_1_ipi_axis_lw_spi_master is
  port (
    m_axis_tdata : out STD_LOGIC_VECTOR ( 7 downto 0 );
    sclk_o : out STD_LOGIC;
    cs_o : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_axi4stream_spi_master_1_1_ipi_axis_lw_spi_master : entity is "ipi_axis_lw_spi_master";
end design_1_axi4stream_spi_master_1_1_ipi_axis_lw_spi_master;

architecture STRUCTURE of design_1_axi4stream_spi_master_1_1_ipi_axis_lw_spi_master is
begin
inst_axis_lw_spi_master: entity work.design_1_axi4stream_spi_master_1_1_axis_lw_spi_master
     port map (
      aclk => aclk,
      aresetn => aresetn,
      cs_o => cs_o,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_axi4stream_spi_master_1_1 is
  port (
    aclk : in STD_LOGIC;
    aresetn : in STD_LOGIC;
    s_axis_tvalid : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of design_1_axi4stream_spi_master_1_1 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_axi4stream_spi_master_1_1 : entity is "design_1_axi4stream_spi_master_1_1,ipi_axis_lw_spi_master,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of design_1_axi4stream_spi_master_1_1 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of design_1_axi4stream_spi_master_1_1 : entity is "package_project";
  attribute x_core_info : string;
  attribute x_core_info of design_1_axi4stream_spi_master_1_1 : entity is "ipi_axis_lw_spi_master,Vivado 2022.2";
end design_1_axi4stream_spi_master_1_1;

architecture STRUCTURE of design_1_axi4stream_spi_master_1_1 is
...
U0: entity work.design_1_axi4stream_spi_master_1_1_ipi_axis_lw_spi_master
     port map (
      aclk => aclk,
      aresetn => aresetn,
      cs_o => cs_o,
