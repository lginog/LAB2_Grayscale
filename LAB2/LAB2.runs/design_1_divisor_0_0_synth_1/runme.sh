...
HD_PWD='D:/Git/LAB2_Grayscale/LAB2/LAB2.runs/design_1_divisor_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_divisor_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_divisor_0_0.tcl
