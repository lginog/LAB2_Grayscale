...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_digilent_jstk2 is
  signal \FSM_onehot_state_sts_reg_n_0_[0]\ : STD_LOGIC;
  signal \FSM_onehot_state_sts_reg_n_0_[1]\ : STD_LOGIC;
  signal \FSM_onehot_state_sts_reg_n_0_[2]\ : STD_LOGIC;
  signal \FSM_onehot_state_sts_reg_n_0_[3]\ : STD_LOGIC;
  signal \FSM_onehot_state_sts_reg_n_0_[4]\ : STD_LOGIC;
  ...
  attribute FSM_ENCODED_STATES of \FSM_onehot_state_sts_reg[0]\ : label is "get_x_lsb:00001,get_x_msb:00010,get_y_lsb:00100,get_y_msb:01000,get_buttons_and_push:10000,";
  attribute FSM_ENCODED_STATES of \FSM_onehot_state_sts_reg[1]\ : label is "get_x_lsb:00001,get_x_msb:00010,get_y_lsb:00100,get_y_msb:01000,get_buttons_and_push:10000,";
  attribute FSM_ENCODED_STATES of \FSM_onehot_state_sts_reg[2]\ : label is "get_x_lsb:00001,get_x_msb:00010,get_y_lsb:00100,get_y_msb:01000,get_buttons_and_push:10000,";
  attribute FSM_ENCODED_STATES of \FSM_onehot_state_sts_reg[3]\ : label is "get_x_lsb:00001,get_x_msb:00010,get_y_lsb:00100,get_y_msb:01000,get_buttons_and_push:10000,";
  attribute FSM_ENCODED_STATES of \FSM_onehot_state_sts_reg[4]\ : label is "get_x_lsb:00001,get_x_msb:00010,get_y_lsb:00100,get_y_msb:01000,get_buttons_and_push:10000,";
...
begin
\FSM_onehot_state_sts_reg[0]\: unisim.vcomponents.FDPE
    generic map(
      INIT => '1'
    )
        port map (
      C => aclk,
      CE => s_axis_tvalid,
      D => \FSM_onehot_state_sts_reg_n_0_[4]\,
      PRE => \m_axis_tdata[7]_i_3_n_0\,
      Q => \FSM_onehot_state_sts_reg_n_0_[0]\
    );
\FSM_onehot_state_sts_reg[1]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
      ...
      D => \FSM_onehot_state_sts_reg_n_0_[0]\,
      Q => \FSM_onehot_state_sts_reg_n_0_[1]\
    );
\FSM_onehot_state_sts_reg[2]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
      ...
      CE => s_axis_tvalid,
      CLR => \m_axis_tdata[7]_i_3_n_0\,
      D => \FSM_onehot_state_sts_reg_n_0_[1]\,
      Q => \FSM_onehot_state_sts_reg_n_0_[2]\
    );
\FSM_onehot_state_sts_reg[3]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
      ...
      CE => s_axis_tvalid,
      CLR => \m_axis_tdata[7]_i_3_n_0\,
      D => \FSM_onehot_state_sts_reg_n_0_[2]\,
      Q => \FSM_onehot_state_sts_reg_n_0_[3]\
    );
\FSM_onehot_state_sts_reg[4]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
      ...
      CE => s_axis_tvalid,
      CLR => \m_axis_tdata[7]_i_3_n_0\,
      D => \FSM_onehot_state_sts_reg_n_0_[3]\,
      Q => \FSM_onehot_state_sts_reg_n_0_[4]\
    );
...
\jstk_x[9]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
      I0 => \FSM_onehot_state_sts_reg_n_0_[4]\,
      I1 => s_axis_tvalid,
      I2 => aresetn,
      O => jstk_x0
    );
...
\m_axis_tdata[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"00000000AFC0A0C0"
        ...
        port map (
      I0 => \packet_snd_reg[1]\(0),
      I1 => \packet_snd_reg[2]\(0),
      I2 => \state_cmd__0\(1),
      I3 => \state_cmd__0\(0),
      I4 => \packet_snd_reg[3]\(0),
      I5 => \state_cmd__0\(2),
...
\m_axis_tdata[1]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"00000000AFC0A0C0"
        ...
        port map (
      I0 => \packet_snd_reg[1]\(1),
      I1 => \packet_snd_reg[2]\(1),
      I2 => \state_cmd__0\(1),
      I3 => \state_cmd__0\(0),
      I4 => \packet_snd_reg[3]\(1),
      I5 => \state_cmd__0\(2),
...
\m_axis_tdata[3]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => \packet_snd_reg[2]\(3),
      I2 => \state_cmd__0\(1),
      I3 => \state_cmd__0\(0),
      I4 => \packet_snd_reg[3]\(3),
      I5 => \state_cmd__0\(2),
...
\m_axis_tdata[4]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => \packet_snd_reg[2]\(4),
      I2 => \state_cmd__0\(1),
      I3 => \state_cmd__0\(0),
      I4 => \packet_snd_reg[3]\(4),
      I5 => \state_cmd__0\(2),
...
\m_axis_tdata[5]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => \packet_snd_reg[2]\(5),
      I2 => \state_cmd__0\(1),
      I3 => \state_cmd__0\(0),
      I4 => \packet_snd_reg[3]\(5),
      I5 => \state_cmd__0\(2),
...
\m_axis_tdata[6]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"00000000AFC0A0C0"
        ...
        port map (
      I0 => \packet_snd_reg[1]\(6),
      I1 => \packet_snd_reg[2]\(6),
      I2 => \state_cmd__0\(1),
      I3 => \state_cmd__0\(0),
      I4 => \packet_snd_reg[3]\(6),
      I5 => \state_cmd__0\(2),
...
\m_axis_tdata[7]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"00000000AFA0CFCF"
        ...
        port map (
      I0 => \packet_snd_reg[1]\(7),
      I1 => \packet_snd_reg[2]\(7),
      I2 => \state_cmd__0\(1),
      I3 => \packet_snd_reg[3]\(7),
      I4 => \state_cmd__0\(0),
      I5 => \state_cmd__0\(2),
...
\packet_rcv[1][0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"BFFF8000"
    )
        port map (
      I0 => s_axis_tdata(0),
      I1 => \FSM_onehot_state_sts_reg_n_0_[3]\,
      I2 => s_axis_tvalid,
      I3 => aresetn,
      I4 => \packet_rcv_reg[1]\(0),
      O => \packet_rcv[1][0]_i_1_n_0\
    );
\packet_rcv[1][1]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"BFFF8000"
    )
        port map (
      ...
      I2 => s_axis_tvalid,
      I3 => aresetn,
      I4 => \packet_rcv_reg[1]\(1),
      O => \packet_rcv[1][1]_i_1_n_0\
    );
\packet_rcv[2][7]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
      I0 => \FSM_onehot_state_sts_reg_n_0_[2]\,
      I1 => s_axis_tvalid,
      I2 => aresetn,
      O => \packet_rcv_reg[2]0\
    );
\packet_rcv[3][0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"BFFF8000"
    )
        port map (
      I0 => s_axis_tdata(0),
      I1 => \FSM_onehot_state_sts_reg_n_0_[1]\,
      I2 => s_axis_tvalid,
      I3 => aresetn,
      I4 => p_0_in(8),
      O => \packet_rcv[3][0]_i_1_n_0\
    );
\packet_rcv[3][1]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"BFFF8000"
    )
        port map (
...
\packet_rcv[4][7]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
      I0 => \FSM_onehot_state_sts_reg_n_0_[0]\,
      I1 => s_axis_tvalid,
      I2 => aresetn,
