...
-- Date        : Mon Apr 10 12:08:21 2023
-- Host        : WIN7390 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               c:/Users/posta/Src/LAB2_git/Joystick/Lab2_JSTK2.gen/sources_1/bd/design_1/ip/design_1_AXI4Stream_UART_0_0/design_1_AXI4Stream_UART_0_0_sim_netlist.vhdl
...
architecture STRUCTURE of design_1_AXI4Stream_UART_0_0_UART_Engine is
  ...
  signal \FSM_onehot_uart_rx_state[0]_i_2_n_0\ : STD_LOGIC;
  ...
  signal \rx_baud_counter[5]_i_1_n_0\ : STD_LOGIC;
  signal \rx_baud_counter[5]_i_3_n_0\ : STD_LOGIC;
  signal rx_baud_counter_reg : STD_LOGIC_VECTOR ( 5 downto 0 );
  signal rx_baud_tick : STD_LOGIC;
  signal rx_baud_tick_i_1_n_0 : STD_LOGIC;
  signal \tx_baud_counter[6]_i_2_n_0\ : STD_LOGIC;
  signal \tx_baud_counter[9]_i_1_n_0\ : STD_LOGIC;
  signal \tx_baud_counter[9]_i_3_n_0\ : STD_LOGIC;
  signal \tx_baud_counter[9]_i_4_n_0\ : STD_LOGIC;
  signal tx_baud_counter_reg : STD_LOGIC_VECTOR ( 9 downto 0 );
  ...
  attribute SOFT_HLUTNM of \FSM_onehot_uart_rx_state[0]_i_2\ : label is "soft_lutpair50";
  attribute SOFT_HLUTNM of \FSM_onehot_uart_rx_state[1]_i_1\ : label is "soft_lutpair55";
  attribute SOFT_HLUTNM of \FSM_onehot_uart_rx_state[2]_i_1\ : label is "soft_lutpair55";
  ...
  attribute SOFT_HLUTNM of \rx_baud_counter[0]_i_1\ : label is "soft_lutpair60";
  attribute SOFT_HLUTNM of \rx_baud_counter[1]_i_1\ : label is "soft_lutpair59";
  attribute SOFT_HLUTNM of \rx_baud_counter[2]_i_1\ : label is "soft_lutpair59";
  attribute SOFT_HLUTNM of \rx_baud_counter[3]_i_1\ : label is "soft_lutpair49";
  attribute SOFT_HLUTNM of \rx_baud_counter[4]_i_1\ : label is "soft_lutpair49";
  attribute SOFT_HLUTNM of \rx_baud_counter[5]_i_3\ : label is "soft_lutpair60";
  attribute SOFT_HLUTNM of \tx_baud_counter[0]_i_1\ : label is "soft_lutpair61";
  attribute SOFT_HLUTNM of \tx_baud_counter[1]_i_1\ : label is "soft_lutpair61";
  attribute SOFT_HLUTNM of \tx_baud_counter[2]_i_1\ : label is "soft_lutpair58";
  ...
  attribute SOFT_HLUTNM of \tx_baud_counter[6]_i_2\ : label is "soft_lutpair58";
  attribute SOFT_HLUTNM of \tx_baud_counter[7]_i_1\ : label is "soft_lutpair48";
  attribute SOFT_HLUTNM of \tx_baud_counter[8]_i_1\ : label is "soft_lutpair48";
  attribute SOFT_HLUTNM of \uart_rx_bit_spacing[0]_i_1\ : label is "soft_lutpair54";
  attribute SOFT_HLUTNM of \uart_rx_bit_spacing[1]_i_1\ : label is "soft_lutpair54";
  ...
  attribute SOFT_HLUTNM of \uart_rx_count[0]_i_1\ : label is "soft_lutpair62";
  attribute SOFT_HLUTNM of \uart_rx_count[1]_i_1\ : label is "soft_lutpair62";
  attribute SOFT_HLUTNM of \uart_rx_count[2]_i_2\ : label is "soft_lutpair50";
...
\FSM_onehot_uart_rx_state[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => uart_rx_bit,
      I5 => \FSM_onehot_uart_rx_state[0]_i_2_n_0\,
      O => \FSM_onehot_uart_rx_state[0]_i_1_n_0\
    );
\FSM_onehot_uart_rx_state[0]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"80000000"
    )
        port map (
      ...
      I2 => \uart_rx_count_reg_n_0_[1]\,
      I3 => \uart_rx_count_reg_n_0_[2]\,
      I4 => \FSM_onehot_uart_rx_state_reg_n_0_[1]\,
      O => \FSM_onehot_uart_rx_state[0]_i_2_n_0\
    );
...
\rx_baud_counter[1]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
        ...
        port map (
      I0 => rx_baud_counter_reg(1),
      I1 => rx_baud_counter_reg(0),
      O => \p_0_in__0\(1)
    );
\rx_baud_counter[2]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"78"
        ...
        port map (
      I0 => rx_baud_counter_reg(0),
      I1 => rx_baud_counter_reg(1),
      I2 => rx_baud_counter_reg(2),
      O => \p_0_in__0\(2)
    );
\rx_baud_counter[3]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"6AAA"
        ...
        port map (
      I0 => rx_baud_counter_reg(3),
      I1 => rx_baud_counter_reg(0),
      I2 => rx_baud_counter_reg(2),
      I3 => rx_baud_counter_reg(1),
      O => \p_0_in__0\(3)
    );
\rx_baud_counter[4]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"6AAAAAAA"
    )
        port map (
      I0 => rx_baud_counter_reg(4),
      I1 => rx_baud_counter_reg(1),
      I2 => rx_baud_counter_reg(2),
      I3 => rx_baud_counter_reg(0),
      I4 => rx_baud_counter_reg(3),
      O => \p_0_in__0\(4)
    );
\rx_baud_counter[5]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFF00200000"
        ...
        port map (
      I0 => rx_baud_counter_reg(5),
      I1 => rx_baud_counter_reg(3),
      I2 => \rx_baud_counter[5]_i_3_n_0\,
      I3 => rx_baud_counter_reg(1),
      I4 => rx_baud_counter_reg(4),
      I5 => rst,
      O => \rx_baud_counter[5]_i_1_n_0\
    );
\rx_baud_counter[5]_i_2\: unisim.vcomponents.LUT6
    generic map(
      ...
      I0 => rx_baud_counter_reg(5),
      I1 => rx_baud_counter_reg(3),
      I2 => rx_baud_counter_reg(0),
      I3 => rx_baud_counter_reg(2),
      I4 => rx_baud_counter_reg(1),
      I5 => rx_baud_counter_reg(4),
      O => \p_0_in__0\(5)
    );
\rx_baud_counter[5]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
      I0 => rx_baud_counter_reg(2),
      I1 => rx_baud_counter_reg(0),
      O => \rx_baud_counter[5]_i_3_n_0\
    );
\rx_baud_counter_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      ...
      CE => '1',
      D => \p_0_in__0\(0),
      Q => rx_baud_counter_reg(0),
      R => \rx_baud_counter[5]_i_1_n_0\
    );
...
\tx_baud_counter[2]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"6A"
        ...
        port map (
      I0 => tx_baud_counter_reg(2),
      I1 => tx_baud_counter_reg(0),
      I2 => tx_baud_counter_reg(1),
      O => p_0_in(2)
    );
\tx_baud_counter[3]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"6AAA"
        ...
        port map (
      I0 => tx_baud_counter_reg(3),
      I1 => tx_baud_counter_reg(0),
      I2 => tx_baud_counter_reg(1),
      I3 => tx_baud_counter_reg(2),
      O => p_0_in(3)
    );
\tx_baud_counter[4]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"6AAAAAAA"
        ...
        port map (
      I0 => tx_baud_counter_reg(4),
      I1 => tx_baud_counter_reg(2),
      I2 => tx_baud_counter_reg(1),
      I3 => tx_baud_counter_reg(0),
      I4 => tx_baud_counter_reg(3),
      O => p_0_in(4)
    );
\tx_baud_counter[5]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"6AAAAAAAAAAAAAAA"
        ...
        port map (
      I0 => tx_baud_counter_reg(5),
      I1 => tx_baud_counter_reg(3),
      I2 => tx_baud_counter_reg(0),
      I3 => tx_baud_counter_reg(1),
      I4 => tx_baud_counter_reg(2),
      I5 => tx_baud_counter_reg(4),
      O => p_0_in(5)
    );
\tx_baud_counter[6]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"6AAAAAAAAAAAAAAA"
        ...
        port map (
      I0 => tx_baud_counter_reg(6),
      I1 => tx_baud_counter_reg(4),
      I2 => tx_baud_counter_reg(2),
      I3 => \tx_baud_counter[6]_i_2_n_0\,
      I4 => tx_baud_counter_reg(3),
      I5 => tx_baud_counter_reg(5),
      O => p_0_in(6)
    );
\tx_baud_counter[6]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
      I0 => tx_baud_counter_reg(1),
      I1 => tx_baud_counter_reg(0),
...
\tx_baud_counter[7]_i_1\: unisim.vcomponents.LUT4
    generic map(
      ...
      I1 => tx_baud_counter_reg(7),
      I2 => \tx_baud_counter[9]_i_4_n_0\,
      I3 => tx_baud_counter_reg(6),
      O => p_0_in(7)
    );
\tx_baud_counter[8]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"BC8CCCCC"
        ...
        port map (
      I0 => \tx_baud_counter[9]_i_3_n_0\,
      I1 => tx_baud_counter_reg(8),
      I2 => tx_baud_counter_reg(6),
      I3 => \tx_baud_counter[9]_i_4_n_0\,
      I4 => tx_baud_counter_reg(7),
      O => p_0_in(8)
    );
\tx_baud_counter[9]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFF20000000"
        ...
        port map (
      I0 => tx_baud_counter_reg(9),
      I1 => tx_baud_counter_reg(7),
      I2 => tx_baud_tick_i_2_n_0,
      I3 => tx_baud_counter_reg(6),
      I4 => tx_baud_counter_reg(8),
      I5 => rst,
      O => \tx_baud_counter[9]_i_1_n_0\
    );
\tx_baud_counter[9]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"BC8CCCCCCCCCCCCC"
        ...
        port map (
      I0 => \tx_baud_counter[9]_i_3_n_0\,
      I1 => tx_baud_counter_reg(9),
      I2 => tx_baud_counter_reg(7),
      I3 => \tx_baud_counter[9]_i_4_n_0\,
      I4 => tx_baud_counter_reg(6),
      I5 => tx_baud_counter_reg(8),
      O => p_0_in(9)
    );
...
\tx_baud_counter[9]_i_4\: unisim.vcomponents.LUT6
    generic map(
...
\tx_baud_counter_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      ...
      CE => '1',
      D => p_0_in(0),
      Q => tx_baud_counter_reg(0),
      R => \tx_baud_counter[9]_i_1_n_0\
    );
...
tx_baud_tick_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00800000"
        ...
        port map (
      I0 => tx_baud_counter_reg(8),
      I1 => tx_baud_counter_reg(6),
      I2 => tx_baud_tick_i_2_n_0,
      I3 => tx_baud_counter_reg(7),
      I4 => tx_baud_counter_reg(9),
      O => tx_baud_tick
    );
...
\uart_rx_bit_spacing[1]_i_1\: unisim.vcomponents.LUT3
    generic map(
      ...
      I0 => uart_rx_bit_spacing,
      I1 => \uart_rx_bit_spacing_reg_n_0_[0]\,
      I2 => \uart_rx_bit_spacing_reg_n_0_[1]\,
...
\uart_rx_bit_spacing[2]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"1444"
        ...
        port map (
      I0 => uart_rx_bit_spacing,
      I1 => \uart_rx_bit_spacing_reg_n_0_[2]\,
      I2 => \uart_rx_bit_spacing_reg_n_0_[0]\,
      I3 => \uart_rx_bit_spacing_reg_n_0_[1]\,
...
\uart_rx_bit_spacing[3]_i_1\: unisim.vcomponents.LUT5
    generic map(
      ...
      I2 => \uart_rx_bit_spacing_reg_n_0_[0]\,
      I3 => \uart_rx_bit_spacing_reg_n_0_[1]\,
      I4 => \uart_rx_bit_spacing_reg_n_0_[2]\,
...
uart_rx_bit_tick_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"80000000"
        ...
        port map (
      I0 => \uart_rx_bit_spacing_reg_n_0_[3]\,
      I1 => \uart_rx_bit_spacing_reg_n_0_[0]\,
      I2 => \uart_rx_bit_spacing_reg_n_0_[1]\,
...
\uart_rx_count[2]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
        ...
        port map (
      I0 => uart_rx_bit_tick,
      I1 => \FSM_onehot_uart_rx_state_reg_n_0_[1]\,
      O => uart_rx_data_vec
    );
...
entity design_1_AXI4Stream_UART_0_0_xpm_fifo_reg_bit_9 is
  port (
    ...
    d_out_int_reg_1 : out STD_LOGIC_VECTOR ( 0 to 0 );
    d_out_int_reg_2 : out STD_LOGIC_VECTOR ( 0 to 0 );
    d_out_int_reg_3 : out STD_LOGIC_VECTOR ( 0 to 0 );
    wrst_busy : in STD_LOGIC;
    wr_clk : in STD_LOGIC;
    rst : in STD_LOGIC;
    \count_value_i_reg[3]\ : in STD_LOGIC;
...
entity design_1_AXI4Stream_UART_0_0_xpm_memory_base is
  ...
  attribute ECC_BIT_RANGE of design_1_AXI4Stream_UART_0_0_xpm_memory_base : entity is "[7:0]";
  attribute ECC_MODE : integer;
  attribute ECC_MODE of design_1_AXI4Stream_UART_0_0_xpm_memory_base : entity is 0;
  attribute ECC_TYPE : string;
  attribute ECC_TYPE of design_1_AXI4Stream_UART_0_0_xpm_memory_base : entity is "NONE";
  attribute IGNORE_INIT_SYNTH : integer;
  attribute IGNORE_INIT_SYNTH of design_1_AXI4Stream_UART_0_0_xpm_memory_base : entity is 0;
...
architecture STRUCTURE of design_1_AXI4Stream_UART_0_0_xpm_memory_base is
  ...
  attribute RTL_RAM_NAME of \gen_wr_a.gen_word_narrow.mem_reg\ : label is "U0/FIFO_DATA_RX/gnuram_async_fifo.xpm_fifo_base_inst/gen_sdpram.xpm_memory_base_inst/gen_wr_a.gen_word_narrow.mem_reg";
...
entity \design_1_AXI4Stream_UART_0_0_xpm_memory_base__2\ is
  ...
  attribute ECC_BIT_RANGE : string;
  attribute ECC_BIT_RANGE of \design_1_AXI4Stream_UART_0_0_xpm_memory_base__2\ : entity is "[7:0]";
  attribute ECC_MODE : integer;
  attribute ECC_MODE of \design_1_AXI4Stream_UART_0_0_xpm_memory_base__2\ : entity is 0;
  attribute ECC_TYPE : string;
  attribute ECC_TYPE of \design_1_AXI4Stream_UART_0_0_xpm_memory_base__2\ : entity is "NONE";
  attribute IGNORE_INIT_SYNTH : integer;
  attribute IGNORE_INIT_SYNTH of \design_1_AXI4Stream_UART_0_0_xpm_memory_base__2\ : entity is 0;
  attribute MAX_NUM_CHAR : integer;
...
architecture STRUCTURE of \design_1_AXI4Stream_UART_0_0_xpm_memory_base__2\ is
  ...
  attribute RTL_RAM_BITS of \gen_wr_a.gen_word_narrow.mem_reg\ : label is 16384;
  attribute RTL_RAM_NAME : string;
  attribute RTL_RAM_NAME of \gen_wr_a.gen_word_narrow.mem_reg\ : label is "U0/FIFO_DATA_TX/gnuram_async_fifo.xpm_fifo_base_inst/gen_sdpram.xpm_memory_base_inst/gen_wr_a.gen_word_narrow.mem_reg";
  attribute RTL_RAM_TYPE : string;
  attribute RTL_RAM_TYPE of \gen_wr_a.gen_word_narrow.mem_reg\ : label is "RAM_SDP";
  attribute ram_addr_begin : integer;
  attribute ram_addr_begin of \gen_wr_a.gen_word_narrow.mem_reg\ : label is 0;
...
architecture STRUCTURE of design_1_AXI4Stream_UART_0_0_UART_Manager is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \data_stream_in[0]_i_1\ : label is "soft_lutpair63";
  attribute SOFT_HLUTNM of \data_stream_in[1]_i_1\ : label is "soft_lutpair63";
  attribute SOFT_HLUTNM of \data_stream_in[2]_i_1\ : label is "soft_lutpair64";
  attribute SOFT_HLUTNM of \data_stream_in[3]_i_1\ : label is "soft_lutpair64";
  attribute SOFT_HLUTNM of \data_stream_in[4]_i_1\ : label is "soft_lutpair65";
  attribute SOFT_HLUTNM of \data_stream_in[5]_i_1\ : label is "soft_lutpair65";
  attribute SOFT_HLUTNM of \data_stream_in[6]_i_1\ : label is "soft_lutpair66";
  attribute SOFT_HLUTNM of \data_stream_in[7]_i_2\ : label is "soft_lutpair66";
begin
  rd_en <= \^rd_en\;
...
rst_d1_inst: entity work.design_1_AXI4Stream_UART_0_0_xpm_fifo_reg_bit_9
     port map (
      ...
      d_out_int_reg_2(0) => rst_d1_inst_n_4,
      d_out_int_reg_3(0) => rst_d1_inst_n_5,
      rst => rst,
      rst_d1 => rst_d1,
      wr_clk => wr_clk,
      wr_en => wr_en,
...
architecture STRUCTURE of design_1_AXI4Stream_UART_0_0_AXI4Stream_UART_v1_0 is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of FIFO_DATA_RX_i_1 : label is "soft_lutpair68";
  ...
  attribute SOFT_HLUTNM of FIFO_DATA_TX_i_2 : label is "soft_lutpair67";
  attribute SOFT_HLUTNM of m00_axis_rx_tvalid_INST_0 : label is "soft_lutpair68";
  attribute SOFT_HLUTNM of s00_axis_tx_tready_INST_0 : label is "soft_lutpair67";
begin
...
entity design_1_AXI4Stream_UART_0_0 is
  ...
  attribute x_core_info of design_1_AXI4Stream_UART_0_0 : entity is "AXI4Stream_UART_v1_0,Vivado 2022.2";
