...
# Design libraries
design_libs=(simprims_ver xpm xil_defaultlib lib_cdc_v1_0_2 proc_sys_reset_v5_0_13)
...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../Lab2_JSTK2.gen/sources_1/bd/design_1/ipshared/7698" \
       +incdir+"../../../../Lab2_JSTK2.gen/sources_1/bd/design_1/ipshared/7698" \
       -input simulate.do
}
