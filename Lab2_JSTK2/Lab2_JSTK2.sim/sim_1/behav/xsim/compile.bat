...
REM
REM Generated by Vivado on Tue Apr 04 17:28:29 +0200 2023
...
echo "xvlog --incr --relax -prj tb_PulseWidthModulator_vlog.prj"
call xvlog  --incr --relax -prj tb_PulseWidthModulator_vlog.prj -log xvlog.log
